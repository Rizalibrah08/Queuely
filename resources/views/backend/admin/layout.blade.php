...
<head>
    ...
    <title>@yield('title') - Admin Queuely</title>
...
<body>
    ...
    <nav class="sidebar">
        <div class="sidebar-header">
            ...
            <p class="small mt-2 mb-0" style="opacity: 0.7;">Admin Panel</p>
        </div>
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.umkm.index') }}"
                        class="nav-link @if(Route::is('admin.umkm*')) active @endif">
                        <i class="fas fa-store"></i>
                        <span>UMKM</span>
                        @php
                            $pendingCount = \App\Models\UMKM::where('status', 'pending')->count();
                        @endphp
                        @if($pendingCount > 0)
        ...
        <div class="sidebar-footer">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 ms-3">
                    ...
                    <div class="small" style="opacity: 0.7;">Administrator</div>
                </div>
            </div>
        </div>
    </nav>
